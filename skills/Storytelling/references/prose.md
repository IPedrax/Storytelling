...
Write in **the world's declared language** (`language:` in its entry note). The craft below is
language-independent; the terminology is English, the sentences are not.

## Psychic distance

Gardner's core idea: the reader sits at some measurable distance from the character's
consciousness, and the writer controls it. Five rough settings, far to near:
...
- **Pick a setting per scene and know what it is.** Most modern fiction lives at 3–4.
- **Move deliberately, and glide.** Open wide, close in as the scene heats, pull back at the end. Jumping 1→4→2 inside a paragraph makes the reader seasick without knowing why.
- **Close in for emotion, pull back for orientation.** New location, time skip, or complex action → step out a level so the reader can see the room. Then come back in.
- Level 5 is expensive. Used for a whole chapter it exhausts; used for three lines at the worst moment it devastates.

## Filter words

Words that report perception instead of delivering it: *saw, heard, felt, noticed, realized,
knew, watched, thought, wondered, seemed, decided, could see.*

> She saw the door standing open. → **The door stood open.**
...
The main engine for close third person: narrate thought and perception from inside the character
without the machinery of *she thought*, italics, or quotation marks. The grammar stays third
person and past tense, but the **idiom, the judgments, and the vocabulary belong to the
character**.
...
narrator's neutral register is just narration.

## Show, tell, and when telling is right
...
Specificity is the cheapest source of authority in fiction. **The specific detail implies the
unspecified world.**
...
- **Vary sentence length on purpose.** Long sentences carry motion and thought; short ones land. A short sentence after three long ones is an event. Three short ones in a row is a hammer.
- **Paragraph is the unit of attention.** A one-line paragraph gets read as important. Spend that.
- **End on the strong word.** Sentence and paragraph endings hold weight; put the important noun there, not a trailing prepositional phrase.
- **Read it aloud.** Nearly every rhythm problem is audible and nearly none is visible.
- White space is pacing. A dense block reads slow whatever it says.
